...
class Player {
  constructor(
    ...
    this.fyOffsetForPlayer = yOffsetForPlayer;
  ...
  socket.on("shoot", function (click) {
    ...
    projectiles.push(
      new Projectile(
        ...
        player.mapWidth,
        player.mapHeight,
        player.xOffsetForPlayer,
        player.yOffsetForPlayer,
        click.angle,
        player.playerX + player.xOffsetForPlayer,
        player.playerY + player.yOffsetForPlayer,
        socket.id,
